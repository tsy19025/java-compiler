...
public class BuildSymbolTableVisitor extends GJDepthFirst< MType , MType> {
   ...
   public MType visit(VarDeclaration n, MType argu) {
      MType _ret=null;
      String type = ((MType)n.f0.accept(this, argu)).type;
      String name = ((MIdentifier) n.f1.accept(this, argu)).name;
   ...
   public MType visit(MethodDeclaration n, MType argu) {
      ...
      String type = ((MType) n.f1.accept(this, argu)).name;
      String name = ((MIdentifier) n.f2.accept(this, argu)).name;
      MMethod method = new MMethod(argu, n.f2.f0.beginLine, n.f2.f0.beginColumn, name, type);
   ...
   public MType visit(FormalParameter n, MType argu) {
      ...
      String type = ((MType) n.f0.accept(this, argu)).name;
      String name = ((MIdentifier) n.f1.accept(this, argu)).name;
      MVar var = new MVar(argu, n.f1.f0.beginLine, n.f1.f0.beginColumn, name, type);
   ...
   public MType visit(Type n, MType argu) {
      ...
      if (ret instanceof MIdentifier)
    	  return new MType(ret.line, ret.column, ret.name);
      return ret;
   }
